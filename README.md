# FMPC_pytorch_polarity_picker_test_data
Test data (seismic waveforms and polarity labels) for the First Motion Polarity Classification (FMPC, Ross et al. 2018) model provided by INGV L'Aquila.
The PyTorch implementation of the FMPC model was developed by Sacha Lapins, and the model weights were translated from the original TensorFlow implementation.
